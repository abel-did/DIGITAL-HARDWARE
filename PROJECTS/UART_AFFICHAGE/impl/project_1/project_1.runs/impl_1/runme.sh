...
HD_PWD='/user/didouha/homedir/E3/S2/P3/EL-3013/UART_AFF/impl/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_aff.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_aff.tcl -notrace

...
HD_PWD='/user/didouha/homedir/E3/S2/P3/EL-3013/UART_AFF/impl/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_aff.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_aff.tcl

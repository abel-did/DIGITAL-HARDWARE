...
HD_PWD='/user/didouha/homedir/E3/S2/P3/EL-3013/dmx_leds/impl/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dmx_leds.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dmx_leds.tcl

...
## ##Pmod Header JA : CLAVIER MATRICIEL 12 TOUCHES
## ##Sch name = JA1
## set_property PACKAGE_PIN J1      [get_ports {rows[3]}]					
## set_property IOSTANDARD LVCMOS33 [get_ports {rows[3]}]
## #Sch name = JA2
## set_property PACKAGE_PIN L2      [get_ports {rows[2]}]					
## set_property IOSTANDARD LVCMOS33 [get_ports {rows[2]}]
## #Sch name = JA3
## set_property PACKAGE_PIN J2      [get_ports {rows[1]}]					
## set_property IOSTANDARD LVCMOS33 [get_ports {rows[1]}]
## #Sch name = JA4
## set_property PACKAGE_PIN G2      [get_ports {rows[0]}]					
...
##Pmod Header JB  => Module DMX EN BAS
##Sch name = JB1
